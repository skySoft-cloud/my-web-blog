...
<ul>
<li>
<font color='#18bc9c'> 打包时提取 CSS 代码到单独的文件中，并自动引入到入口的HTML文件中；</font>
</li>
<li>
<font color='#18bc9c'>打包时压缩 CSS 代码；</font>
</li>
</ul>
...
<ul>
<li>
<font color='#18bc9c'>对CSS代码做兼容处理，比如自动为需要处理的CSS属性添加前缀</font>
</li>
<li>
<font color='#18bc9c'>指定需要做兼容的浏览器</font>
</li>
</ul>
...
<ul>
<li>
<font color='#18bc9c'>postcss-loader 需要放到 css-loader 和 MiniCssExtractPlugin.loader 之后使用</font>
</li>
<li>
<font color='#18bc9c'>需要在根目录创建一个名字为 postcss.config.js 文件，在其中引入postcss-preset-env，postcss.config.js </font>如下配置：
...
<li>
<font color='#18bc9c'>需要在 package.json 中指定 browserlist 属性，并对开发环境和生产环境做不同的配置</font>，package.json 如下配置：
